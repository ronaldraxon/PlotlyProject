...
anscombeData2 <- data_frame(x=c(10.0,8.0,13.0,9.0,11.0,14.0,6.0,4.0,12.0,7.0,5.0),
                            y=c(9.14,8.14,8.74,8.77,9.26,8.10,6.13,3.10,9.13,7.26,4.74))
anscombeData3 <- data_frame(x=c(10.0,8.0,13.0,9.0,11.0,14.0,6.0,4.0,12.0,7.0,5.0),
                            y=c(7.46,6.77,12.74,7.11,7.81,8.84,6.08,5.39,8.15,6.42,5.73))
anscombeData4 <- data_frame(x=c(10.0,8.0,13.0,9.0,11.0,14.0,6.0,4.0,12.0,7.0,5.0),
                            y=c(6.58,5.76,7.71,8.84,8.47,7.04,5.25,12.50,5.56,7.91,6.89))

p1 <- plot_ly(anscombeData1, x = ~x, y = ~y,type="scatter", mode = 'markers') %>%
  add_lines(name = ~"distri1")

p2 <- plot_ly(anscombeData2, x = ~x, y = ~y,type="scatter",mode = 'markers') %>%
  add_lines(name = ~"distri2")
